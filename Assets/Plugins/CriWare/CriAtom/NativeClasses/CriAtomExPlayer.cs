...
public class CriAtomExPlayer : IDisposable
{
	 ...
	 * \par 説明:
	 * メモリ上に配置された音声データをAtomExプレーヤに関連付けます。<br/>
    ...
    /**
     * <summary>バスセンドレベルの設定（バスID指定）</summary>
     * <param name="busId">バスID</param>
     * <param name="level">センドレベル値（0.0f～1.0f）</param>
	 * \par 説明:
	 * バスセンドレベルを指定します。<br/>
	 * 詳細はバス名指定の同名関数を参照してください。<br/>
     */
    ...
    /**
     * <summary>オフセットによるバスセンドレベルの設定（バスID指定）</summary>
     * <param name="busId">バスID</param>
     * <param name="levelOffset">センドレベル値（0.0f～1.0f）</param>
	 * \par 説明:
	 * バスセンドレベルをオフセットで指定します。<br/>
	 ...
	 * \attention
	 * 再生を開始し、指定したボイスリミットグループのボイスが全て使用中だった場合、
